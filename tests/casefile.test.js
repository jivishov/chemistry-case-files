...
import { notationHTML } from '../shared/js/notation.js';
...
// Validate the eleven deployed case files.
const UNITS = [
  { unit: '01', CASE: U1 },
  { unit: '02', CASE: U2 },
  { unit: '03', CASE: U3 },
...
// The published scientific copy permits punctuation such as O–H and pressure–volume.
...
for (const { unit, CASE } of ALL) {
  ...
  t(`unit ${unit}: teaser carries its copy`, chip.includes(notationHTML(CASE.teaser)));
}
