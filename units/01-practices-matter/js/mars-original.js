// Original animated vector stage retained from commit 657646d.
// Kept independent of photographic assets for low-bandwidth or failed-image fallback.
export const ORIGINAL_MARS_STAGE = `<svg viewBox="0 0 640 360" role="img" aria-label="Animated diagram comparing the planned and estimated Mars Climate Orbiter trajectories">
            <defs>
              <radialGradient id="cf1-original-mars" cx="35%" cy="35%" r="80%">
                <stop offset="0%" stop-color="#e08a5a"/><stop offset="60%" stop-color="#b85433"/><stop offset="100%" stop-color="#6e2f1c"/>
              </radialGradient>
              <radialGradient id="cf1-original-earth" cx="35%" cy="35%" r="80%">
            ...
            <!-- Earth -->
            <g>
              <circle cx="62" cy="298" r="17" fill="url(#cf1-original-earth)"/>
            ...
            <g>
              ...
              <circle cx="512" cy="118" r="56" fill="url(#cf1-original-mars)"/>
