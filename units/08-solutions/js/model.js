...
export const SCENARIOS = [
  ...
  { id: 'c-tea', stage: 'curve', skill: 'c', type: 'dose',
    ...
    goal: 'Everyone already knows sugar goes into hot tea and sits at the bottom of iced tea. The curve on the screen says exactly how much, and the same curve is what the plant reads. Read the solubility off it at the temperature marked, in grams per 100 g of water.',
  ...
  { id: 'c-basin', stage: 'curve', skill: 'c', type: 'dose',
    ...
    goal: 'The basin runs cold overnight and everything dosed into it has to stay in solution until morning. Read the solubility off the curve at the basin temperature marked on the chart.',
    ...
    constraints: { solutes: ['KNO3', 'NaNO3', 'KClO3', 'NH4Cl'], temps: [70, 80, 90] },
    bands: CURVE_BANDS,
    delta: { ok: -0.04, low: 0.03, high: 0.03 },
    actionLabel: 'Submit the reading',
    safeState: 'READ RIGHT', lowState: 'READ LOW', highState: 'READ HIGH',
    safe: 'The overnight dose is set to what the basin can actually hold at its coldest, and in the morning it is still in solution and still working.',
