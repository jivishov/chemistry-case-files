...
// Carries the story AND the stage art; the chrome comes from shared/js/casefile.js.
...
export const CASE = {
  ...
  stats: [
    ...
    { v: '~10 g', k: 'of Li inside your phone' }
  ],
  steps: [
    {
      t: 'The 1% panic',
    ...
    },
    {
      ...
      chem: 'At the anode: Li becomes Li+ plus e-. Low ionization energy is what makes that push cheap, which is why the trend you are plotting IS the battery voltage story.',
    ...
    },
    {
      ...
      chem: 'Same family means same chemistry with shifted numbers. Na is even easier to ionize but pays for it in size and mass. Trend literacy is battery literacy.',
  ...
  cta: { label: 'Explore the trends behind the battery', call: "mode='trends'" },
  stage: `<svg viewBox="0 0 640 360" role="img" aria-label="Animated scene: a lithium-ion cell discharges, lithium ions crossing the electrolyte while electrons power a phone">
            <!-- phone -->
            <g>
              <rect x="36" y="66" width="112" height="222" rx="16" fill="#0d1a21" stroke="#3a545f" stroke-width="2"/>
            ...
            <path d="M 236,120 L 236,86 L 560,86 L 560,120" fill="none" stroke="#3a545f" stroke-width="3"/>
            ...
            <text x="398" y="76" text-anchor="middle" font-family="JetBrains Mono" font-size="10" fill="#7fc4d0">e- do the work out here</text>
            ...
            <!-- cell body -->
            <rect x="216" y="120" width="384" height="196" rx="10" fill="#10202a" stroke="#2c414d"/>
            ...
            <g>
              ...
              <text x="241" y="330" text-anchor="middle" font-family="JetBrains Mono" font-size="10" fill="#8fa9b2">graphite</text>
            </g>
            <!-- cathode -->
            <rect x="562" y="132" width="26" height="172" rx="4" fill="#3a2f3c"/>
            <text x="575" y="330" text-anchor="middle" font-family="JetBrains Mono" font-size="10" fill="#8fa9b2">oxide</text>
            <!-- separator -->
            <line x1="408" y1="128" x2="408" y2="308" stroke="#2c414d" stroke-dasharray="5 6"/>
            ...
            <text x="408" y="300" text-anchor="middle" font-family="JetBrains Mono" font-size="10" fill="#8fa9b2" opacity=".9">electrolyte: Li+ swim lane</text>

            <!-- step 2 overlay: the top-left map -->
            <g x-show="step===1">
              <rect x="300" y="140" width="216" height="126" rx="8" fill="#0d1a21" stroke="#2c414d"/>
              <text x="408" y="160" text-anchor="middle" font-family="JetBrains Mono" font-size="10" fill="#8fa9b2">THE TREASURE MAP</text>
              <g font-family="JetBrains Mono" font-size="11">
                <rect x="318" y="172" width="30" height="30" rx="4" fill="#132530" stroke="#2c414d"/><text x="333" y="191" text-anchor="middle" fill="#c3d6dc">H</text>
                ...
                <rect x="352" y="208" width="30" height="30" rx="4" fill="#132530" stroke="#2c414d"/><text x="367" y="227" text-anchor="middle" fill="#c3d6dc">Be</text>
                <rect x="318" y="242" width="30" height="30" rx="4" fill="#132530" stroke="#2c414d"/><text x="333" y="261" text-anchor="middle" fill="#c3d6dc">Na</text>
                <rect x="352" y="242" width="30" height="30" rx="4" fill="#132530" stroke="#2c414d"/><text x="367" y="261" text-anchor="middle" fill="#c3d6dc">Mg</text>
              </g>
              <g font-family="JetBrains Mono" font-size="9" fill="#8fd9ae">
