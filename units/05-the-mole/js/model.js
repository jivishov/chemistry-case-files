...
// Pure data + the standards map. All quantitative work (molar mass, percent
// composition, empirical/combustion formulas) lives in shared/js/chem.js; this
// file only holds the substance pools the procedural generators draw from.
...
export const SCENARIOS = [
  ...
  { id: 'a-oxygen', stage: 'molg', skill: 'a', type: 'dose',
  ...
  { id: 'a-fuel', stage: 'molg', skill: 'a', type: 'dose',
  ...
  { id: 'a-scrubber', stage: 'molg', skill: 'a', type: 'dose',
  ...
  { id: 'b-eva', stage: 'particles', skill: 'b', type: 'dose',
  ...
  { id: 'b-ration', stage: 'particles', skill: 'b', type: 'dose',
  ...
  { id: 'b-sample', stage: 'particles', skill: 'b', type: 'dose',
  ...
  { id: 'c-ore', stage: 'percent', skill: 'c', type: 'decision',
  ...
  { id: 'c-greenhouse', stage: 'percent', skill: 'c', type: 'decision',
  ...
  { id: 'c-fuelpurity', stage: 'percent', skill: 'c', type: 'decision',
  ...
  { id: 'd-leak', stage: 'formula', skill: 'd', type: 'identity',
  ...
  { id: 'd-surface', stage: 'formula', skill: 'd', type: 'identity',
  ...
  { id: 'd-coolant', stage: 'formula', skill: 'd', type: 'identity',
  ...
  { id: 'h1-desiccant', stage: 'formula', skill: 'h1', type: 'identity',
  ...
  { id: 'h2-arson', stage: 'formula', skill: 'h2', type: 'identity',
  ...
  { id: 'cap-pod', stage: 'capstone', skill: 'cap', type: 'decision',
