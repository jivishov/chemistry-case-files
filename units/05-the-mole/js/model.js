...
export const SCENARIOS = [
  ...
  { id: 'c-ore', stage: 'percent', skill: 'c', type: 'decision', stock: 'hull',
    ...
    goal: 'A micrometeor cracked the hull. The rover bagged a rust-colored rock and its assay tagged the sample with an iron grade. Compute the real percent iron for hematite and decide whether the tag holds up well enough to smelt.',
    why: 'A hull breach is a slow leak you cannot ignore. But firing up the foundry on a rock whose assay does not match hematite wastes power the ship cannot spare.',
    constraints: { formula: 'Fe2O3', element: 'Fe' },
    options: [
      { key: 'accept', label: 'Smelt it into a patch', correct: null,
        good: 'The assay matches hematite, the foundry pours a solid patch, and the hull seals.',
        consequence: 'You smelt a rock whose assay never matched hematite, burn the power, and the patch is too thin to hold. The leak keeps hissing.' },
      { key: 'reject', label: 'Keep looking', correct: null,
        good: 'You bounce the mis-tagged rock and the rover finds a vein that assays true before the air gets low.',
        consequence: 'You walked away from ore that assayed exactly as tagged. The breach widens while the rover hunts for nothing.' }
    ] },
...
export const MISCONCEPTIONS = {
  ...
  wrongUnit: { label: 'I chose the wrong target unit',
    fix: 'The bottom unit can cancel and still leave the wrong unit on top. The numerator has to be the unit the problem asks for.' },
