// model.js: Unit 9 domain data (Acids & Bases, TEKS C.12). Pure data + the
...
export const SCENARIOS = [
  ...
  { id: 'b-ammonia', stage: 'define', skill: 'b', type: 'decision',
    ...
    goal: 'A caller wants to know how the ammonia cleaner under their sink can be basic when there is no OH in it. Say which definition covers the statement in front of you, and which side of the pair it describes.',
    why: 'Arrhenius is the definition most people carry, and it cannot explain ammonia at all. Bronsted-Lowry can, because it moves the question from what a substance releases to what it does with a proton. Half the calls on this line are substances Arrhenius has nothing to say about.',
    constraints: { kinds: ['framework'] },
    delta: { ok: 0, wrong: 0 }, minutes: { ok: 6, wrong: 17 },
    actionLabel: 'Answer the caller',
    right: 'The explanation lands, the caller understands why the bottle is dangerous with bleach, and the call ends without a trip to anybody.',
  ...
  { id: 'd-decon', stage: 'neutralize', skill: 'd', type: 'dose',
    ...
    saltWrong: 'The dose is right, so the drum is neutral. The salt call is what is wrong, and on a drum going to a public drain the salt is exactly what the paperwork asks for: a sulfate and a chloride are not the same line on the form.',
