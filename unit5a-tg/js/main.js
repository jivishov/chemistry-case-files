...
export function createSim() {
  return {
    ...
    // the stage brief for the currently active mode (drives the persistent scene frame).
    // honors sub-briefs stay inline in their own block; this returns the primary stage.
    get activeBrief() {
      const m = this.mode;
      return m === 'molg' || m === 'particles' ? this.cvBrief
           : m === 'percent' ? this.pcBrief
           : m === 'formula' ? this.foBrief
           : m === 'capstone' ? this.capBrief
           : null;
    },
