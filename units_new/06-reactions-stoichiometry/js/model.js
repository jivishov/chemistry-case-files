...
export const SCENARIOS = [
  ...
  { id: 'b-ditch', stage: 'classify', skill: 'b', type: 'decision',
    ...
    goal: 'The tanker is on its side and the acid in the ditch has met the caustic you just laid across it. It is warm to the back of your hand through the glove and it has stopped climbing. Classify it.',
  ...
  { id: 'd-shack', stage: 'lr', skill: 'd', type: 'dose',
    ...
    goal: 'A gas heater has been running in a sealed shack on the lake. You know the methane charge that burned and the oxygen that was in the room. Work out the mass of carbon dioxide the reaction actually produced.',
  ...
  { id: 'd-ditch', stage: 'lr', skill: 'd', type: 'dose',
    system: 'The caustic soda on the truck', icon: '\u{1F69B}',
    ...
    constraints: { reaction: 'neutralize' },
    bands: DOSE_BANDS,
    // The only core stage that actually commits reagent: this call lays caustic soda in a
  ...
  { id: 'h1-particles', stage: 'honors1', skill: 'h1', type: 'dose',
    ...
    goal: 'The state lab wants the product of the call you just sized reported as a count of particles, not as a mass. Convert the mass this reaction made into representative particles.',
  ...
  { id: 'cap-tanker', stage: 'capstone', skill: 'cap', type: 'decision',
    ...
    goal: 'A tanker is leaking hydrochloric acid into a storm drain that runs to the creek. You have balanced it, you know it is an acid-base neutralisation, and you have the mass of caustic soda it takes. Now check that against what is actually on your truck and make one call.',
